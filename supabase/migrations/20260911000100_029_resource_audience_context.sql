...
-- Instructors may manage program resources and resources for cohorts they teach.
-- Do not expose another instructor's cohort-only resource through the staff list.
