...
import {
  LayoutDashboard, BookOpen, Mail, Award, User,
  CalendarDays, Video, ClipboardList, BarChart3, FolderOpen,
  MessageSquare, HelpCircle, Megaphone, Users, GraduationCap,
  Settings, FolderTree, ScrollText, Layers, ClipboardCheck,
} from 'lucide-react';
...
export const instructorNav: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: 'Live Sessions', path: '/instructor/live-sessions', icon: Video },
      ...
      { label: 'Communications', path: '/instructor/communications', icon: Megaphone },
    ],
  },
];
...
export const adminNav: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Academic Management', path: '/admin/academic', icon: GraduationCap },
    ],
  },
  {
