...
const StudentCourses = lazyNamed(
  () => import("@/pages/student/StudentCourses"),
  "StudentCourses",
);
const StudentMessages = lazyNamed(
  () => import("@/pages/student/StudentMessages"),
  "StudentMessages",
);
const StudentCertificates = lazyNamed(
  () => import("@/pages/student/StudentCertificates"),
  "StudentCertificates",
);
const StudentCertificateDetail = lazyNamed(
  () => import("@/pages/student/StudentCertificateDetail"),
...
const CourseHome = lazyNamed(
  () => import("@/pages/student/course/CourseHome"),
  "CourseHome",
);
const CourseLearn = lazyNamed(
  () => import("@/pages/student/course/CourseLearn"),
  "CourseLearn",
);
const CourseAssessments = lazyNamed(
  () => import("@/pages/student/course/CourseAssessments"),
  "CourseAssessments",
);
const CourseActivities = lazyNamed(
  () => import("@/pages/student/course/CourseActivities"),
  "CourseActivities",
);
const CourseLive = lazyNamed(
...
const LessonPage = lazyNamed(
  () => import("@/pages/student/course/LessonPage"),
  "LessonPage",
);
const loadCourseSupportPages = () =>
  import("@/pages/student/course/CourseSupportPages");
const CourseAnnouncements = lazyNamed(
  loadCourseSupportPages,
  "CourseAnnouncements",
);
const CourseDiscussions = lazyNamed(
  () => import("@/pages/student/course/CourseDiscussionBoard"),
  "CourseDiscussions",
);
...
const InstructorCourses = lazyNamed(
  () => import("@/pages/instructor/InstructorCourses"),
  "InstructorCourses",
);
const loadInstructorPages = () => import("@/pages/instructor/InstructorPages");
const InstructorLiveSessions = lazyNamed(
  loadInstructorPages,
  "InstructorLiveSessions",
);
const InstructorAssignments = lazyNamed(
  loadInstructorPages,
  "InstructorAssignments",
);
const InstructorAttendance = lazyNamed(
  loadInstructorPages,
  "InstructorAttendance",
);
const InstructorGradebook = lazyNamed(
  loadInstructorPages,
  "InstructorGradebook",
);
const InstructorStudents = lazyNamed(loadInstructorPages, "InstructorStudents");
const InstructorCommunications = lazyNamed(
  loadInstructorPages,
...
const AdminCohorts = lazyNamed(
  () => import("@/pages/admin/AdminCohorts"),
  "AdminCohorts",
);
const AdminEnrolments = lazyNamed(
  () => import("@/pages/admin/AdminEnrolments"),
  "AdminEnrolments",
);
...
const AdminAcademic = lazyNamed(
  () => import("@/pages/admin/AdminAcademic"),
  "AdminAcademic",
);
const AdminReleaseRules = lazyNamed(
  () => import("@/pages/admin/AdminReleaseRules"),
  "AdminReleaseRules",
);
const AdminResources = lazyNamed(
  () => import("@/pages/admin/AdminResources"),
  "AdminResources",
);
const AdminReporting = lazyNamed(
  () => import("@/pages/admin/AdminReporting"),
  "AdminReporting",
);
const AdminCertificateManagement = lazyNamed(
...
const CertificateVerification = lazyNamed(
  () => import("@/pages/public/CertificateVerification"),
...
if (import.meta.env.DEV) {
  publicRoutes.push({
    path: "/dev/ai-business-essentials",
    Component: lazyNamed(
      () => import("@/pages/dev/DevCoursePreview"),
      "DevCoursePreview",
    ),
  });
}
