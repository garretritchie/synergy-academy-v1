...
expect(content.modules.reduce((total, item) => total + item.screens.length, 0) === 286, "Expected 286 eLearning screens");
...
expect(content.activities.length === 13, "Every learning module, including Introduction, must have an activity");
