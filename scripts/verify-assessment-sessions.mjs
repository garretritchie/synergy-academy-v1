...
import {seedSubmissionRepair,testSubmissionRepair} from './fixtures/submission-repair.mjs';
import {testUngradedRevisions} from './fixtures/ungraded-revisions.mjs';
import {testResourceAudiences} from './fixtures/resource-audiences.mjs';
import {testLessonResume} from './fixtures/lesson-resume.mjs';
const db=new PGlite();
...
try{await tests(db,fixture);await testUngradedRevisions(db,fixture);await testResourceAudiences(db,fixture);await testLessonResume(db,fixture);}catch(e){console.error(e);process.exitCode=1;}
